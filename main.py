...
def generate_chart(symbol, history, image_arr=None, entry_price=None, mcap=None,
    ...
    try:
        ...
        fig, ax_main = plt.subplots(figsize=(10, 6.2))
        ...
        ax_head = fig.add_subplot(gs[0]); ax_head.axis("off"); ax_head.set_facecolor(card_bg)
        ax_stats = fig.add_subplot(gs[1]); ax_stats.axis("off"); ax_stats.set_facecolor(card_bg)
